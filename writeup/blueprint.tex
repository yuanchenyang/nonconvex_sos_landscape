...
\]
So the old statement that the proof was complete up to normalization was too
optimistic. The unresolved work is now concentrated in this mixed-affine
subbranch.
...
\item Treat the mixed-affine branch
  \[
    ...
    (1,x_1,x_1^2,x_2^2)
  \]
  separately. Numerically this branch behaves exactly like the conjecture
  predicts, but the written proof of its quotient generators is not complete
  yet.
...
classification and explicit kernel certificates for the mixed-affine
constant-containing $\dim = 2$ branch, then assemble the final theorem.
