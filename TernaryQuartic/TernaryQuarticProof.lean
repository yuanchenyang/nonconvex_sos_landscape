import TernaryQuartic.TernaryQuarticProof.Basic
...
`TernaryQuartic/verify.sh` passes. All helper lemmas and proof
development should go in the `TernaryQuartic/TernaryQuarticProof/` folder.
