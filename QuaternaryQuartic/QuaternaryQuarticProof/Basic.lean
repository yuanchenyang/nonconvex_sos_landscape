import QuaternaryQuartic.QuaternaryQuarticProof.Dimension
import QuaternaryQuartic.QuaternaryQuarticProof.Binary
import QuaternaryQuartic.QuaternaryQuarticProof.Support
import QuaternaryQuartic.QuaternaryQuarticProof.Syzygy
...
def HasRankTwoApolarLowAnnihilatorContradiction
    (B : DotForm) (p : Poly) (u : RankSevenVec) : Prop :=
  Module.finrank ℝ (LinearMap.range (catalecticantMap B p u)) = 2 →
    Module.finrank ℝ (linearAnnihilator B p u) ≤ 1 →
      False

def HasRankThreeApolarZeroAnnihilatorContradiction
    (B : DotForm) (p : Poly) (u : RankSevenVec) : Prop :=
  Module.finrank ℝ (LinearMap.range (catalecticantMap B p u)) = 3 →
    Module.finrank ℝ (linearAnnihilator B p u) = 0 →
      False

def HasRankTwoThreeApolarAnnihilatorContradictions
    (B : DotForm) (p : Poly) (u : RankSevenVec) : Prop :=
...
def HasGlobalRankThreeApolarAnnihilatorDimensionBound : Prop :=
  ∀ (B : DotForm) (p : Poly) (u : RankSevenVec)
    (_hu : IsAdmissiblePoint u),
    IsPositiveDefinite B →
      IsSOSQuartic p →
...
def HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds : Prop :=
  ∀ (B : DotForm) (p : Poly) (u : RankSevenVec)
    (_hu : IsAdmissiblePoint u),
    IsPositiveDefinite B →
      IsSOSQuartic p →
...
def HasGlobalRankTwoThreeApolarAnnihilatorContradictions : Prop :=
  ∀ (B : DotForm) (p : Poly) (u : RankSevenVec)
    (_hu : IsAdmissiblePoint u),
    IsPositiveDefinite B →
      IsSOSQuartic p →
...
def HasGlobalLowRankApolarHilbertData : Prop :=
  ∀ (B : DotForm) (p : Poly) (u : RankSevenVec)
    (_hu : IsAdmissiblePoint u),
    IsPositiveDefinite B →
      IsSOSQuartic p →
...
theorem rankThreeEssentialQuotientBound_of_rankThreeDimensionBound
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hdim : HasRankThreeApolarAnnihilatorDimensionBound B p u) :
    HasRankThreeApolarEssentialQuotientBound B p u := by
  intro hrank3
...
theorem rankThreeBadBranchContradiction_iff_rankThreeDimensionBound
    {B : DotForm} {p : Poly} {u : RankSevenVec} :
    HasRankThreeApolarBadBranchContradiction B p u ↔
      HasRankThreeApolarAnnihilatorDimensionBound B p u :=
  ⟨fun hbad =>
      rankThreeDimensionBound_of_rankThreeEssentialQuotientBound
        (rankThreeEssentialQuotientBound_of_badBranchContradiction hbad),
    fun hdim =>
      rankThreeBadBranchContradiction_of_rankThreeEssentialQuotientBound
        (rankThreeEssentialQuotientBound_of_rankThreeDimensionBound hdim)⟩

theorem rankTwoLowAnnihilatorContradiction_of_rankTwoDimensionBound
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hdim : HasRankTwoApolarAnnihilatorDimensionBound B p u) :
    HasRankTwoApolarLowAnnihilatorContradiction B p u := by
  intro hrank2 hlow
  have hdim2 := hdim hrank2
  omega

theorem rankTwoDimensionBound_of_lowAnnihilatorContradiction
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hcontra : HasRankTwoApolarLowAnnihilatorContradiction B p u) :
    HasRankTwoApolarAnnihilatorDimensionBound B p u := by
  intro hrank2
  by_contra hnot
  have hlow : Module.finrank ℝ (linearAnnihilator B p u) ≤ 1 := by
    omega
  exact hcontra hrank2 hlow

theorem rankTwoLowAnnihilatorContradiction_iff_rankTwoDimensionBound
    {B : DotForm} {p : Poly} {u : RankSevenVec} :
    HasRankTwoApolarLowAnnihilatorContradiction B p u ↔
      HasRankTwoApolarAnnihilatorDimensionBound B p u :=
  ⟨rankTwoDimensionBound_of_lowAnnihilatorContradiction,
    rankTwoLowAnnihilatorContradiction_of_rankTwoDimensionBound⟩

theorem rankThreeZeroAnnihilatorContradiction_of_rankThreeDimensionBound
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hdim : HasRankThreeApolarAnnihilatorDimensionBound B p u) :
...
theorem rankThreeDimensionBound_of_zeroAnnihilatorContradiction
    {B : DotForm} {p : Poly} {u : RankSevenVec}
  ...
  have hzero : Module.finrank ℝ (linearAnnihilator B p u) = 0 := by
    omega
  exact hcontra hrank3 hzero

theorem rankThreeZeroAnnihilatorContradiction_iff_rankThreeDimensionBound
    {B : DotForm} {p : Poly} {u : RankSevenVec} :
    HasRankThreeApolarZeroAnnihilatorContradiction B p u ↔
      HasRankThreeApolarAnnihilatorDimensionBound B p u :=
...
theorem rankTwoThreeAnnihilatorContradictions_of_dimensionBounds
    ...
    (hdims : HasRankTwoThreeApolarAnnihilatorDimensionBounds B p u) :
    HasRankTwoThreeApolarAnnihilatorContradictions B p u :=
  ⟨rankTwoLowAnnihilatorContradiction_of_rankTwoDimensionBound hdims.1,
    rankThreeZeroAnnihilatorContradiction_of_rankThreeDimensionBound hdims.2⟩

theorem rankTwoThreeDimensionBounds_of_annihilatorContradictions
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hcontra : HasRankTwoThreeApolarAnnihilatorContradictions B p u) :
    HasRankTwoThreeApolarAnnihilatorDimensionBounds B p u :=
  ⟨rankTwoDimensionBound_of_lowAnnihilatorContradiction hcontra.1,
    rankThreeDimensionBound_of_zeroAnnihilatorContradiction hcontra.2⟩

theorem rankTwoThreeAnnihilatorContradictions_iff_dimensionBounds
    {B : DotForm} {p : Poly} {u : RankSevenVec} :
    HasRankTwoThreeApolarAnnihilatorContradictions B p u ↔
      HasRankTwoThreeApolarAnnihilatorDimensionBounds B p u :=
  ⟨rankTwoThreeDimensionBounds_of_annihilatorContradictions,
    rankTwoThreeAnnihilatorContradictions_of_dimensionBounds⟩
...
theorem rankTwoMacaulayGrowthData_of_rankTwoMacaulayGrowthBound
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hgrowth : HasRankTwoApolarMacaulayGrowthBound B p u) :
    HasRankTwoApolarMacaulayGrowthData B p u :=
  rankTwoMacaulayGrowthData_of_rankTwoEssentialQuotientBound
    (rankTwoEssentialQuotientBound_of_macaulayGrowth hgrowth)

theorem rankTwoMacaulayGrowthBound_of_rankTwoMacaulayGrowthData
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hdata : HasRankTwoApolarMacaulayGrowthData B p u) :
    HasRankTwoApolarMacaulayGrowthBound B p u :=
  rankTwoMacaulayGrowthBound_of_rankTwoEssentialQuotientBound
...
theorem rankTwoMacaulayGrowthData_iff_rankTwoMacaulayGrowthBound
    {B : DotForm} {p : Poly} {u : RankSevenVec} :
    HasRankTwoApolarMacaulayGrowthData B p u ↔
      HasRankTwoApolarMacaulayGrowthBound B p u :=
  ⟨rankTwoMacaulayGrowthBound_of_rankTwoMacaulayGrowthData,
    rankTwoMacaulayGrowthData_of_rankTwoMacaulayGrowthBound⟩

theorem lowRankApolarHilbertData_of_rankTwoMacaulayGrowth_rankThreeExactSequenceData
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hgrowth2 : HasRankTwoApolarMacaulayGrowthBound B p u)
    (hdata3 : HasRankThreeApolarExactSequenceData B p u) :
    HasLowRankApolarHilbertData B p u :=
  ⟨rankTwoMacaulayGrowthData_of_rankTwoMacaulayGrowthBound hgrowth2,
    hdata3⟩

theorem rankTwoMacaulayGrowth_and_rankThreeExactSequenceData_of_lowRankApolarHilbertData
    {B : DotForm} {p : Poly} {u : RankSevenVec}
    (hdata : HasLowRankApolarHilbertData B p u) :
    HasRankTwoApolarMacaulayGrowthBound B p u ∧
      HasRankThreeApolarExactSequenceData B p u :=
  ⟨rankTwoMacaulayGrowthBound_of_rankTwoMacaulayGrowthData hdata.1,
    hdata.2⟩

theorem lowRankApolarHilbertData_iff_rankTwoMacaulayGrowth_and_rankThreeExactSequenceData
    {B : DotForm} {p : Poly} {u : RankSevenVec} :
    HasLowRankApolarHilbertData B p u ↔
      HasRankTwoApolarMacaulayGrowthBound B p u ∧
        HasRankThreeApolarExactSequenceData B p u :=
  ⟨rankTwoMacaulayGrowth_and_rankThreeExactSequenceData_of_lowRankApolarHilbertData,
    fun hdata =>
      lowRankApolarHilbertData_of_rankTwoMacaulayGrowth_rankThreeExactSequenceData
        hdata.1 hdata.2⟩
...
theorem globalRankTwoThreeApolarAnnihilatorMapBounds_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
    (hdims : HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds) :
    HasGlobalRankTwoThreeApolarAnnihilatorMapBounds := by
  intro B p u hu hB hp hsocp
  exact ⟨
    rankTwoApolarAnnihilatorMapBound_of_rankTwoDimensionBound
      (hdims B p u hu hB hp hsocp).1,
    rankThreeApolarAnnihilatorMapBound_of_rankThreeDimensionBound
      (hdims B p u hu hB hp hsocp).2⟩

theorem globalRankTwoThreeApolarAnnihilatorDimensionBounds_of_globalRankTwoThreeApolarAnnihilatorMapBounds
    (hbounds : HasGlobalRankTwoThreeApolarAnnihilatorMapBounds) :
    HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds := by
  intro B p u hu hB hp hsocp
  exact ⟨
    rankTwoDimensionBound_of_rankTwoApolarAnnihilatorMapBound
      (hbounds B p u hu hB hp hsocp).1,
    rankThreeDimensionBound_of_rankThreeApolarAnnihilatorMapBound
      (hbounds B p u hu hB hp hsocp).2⟩

theorem globalRankTwoThreeApolarAnnihilatorDimensionBounds_iff_globalRankTwoThreeApolarAnnihilatorMapBounds :
    HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds ↔
      HasGlobalRankTwoThreeApolarAnnihilatorMapBounds :=
  ⟨globalRankTwoThreeApolarAnnihilatorMapBounds_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds,
    globalRankTwoThreeApolarAnnihilatorDimensionBounds_of_globalRankTwoThreeApolarAnnihilatorMapBounds⟩

theorem globalRankTwoThreeApolarAnnihilatorContradictions_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
    (hdims : HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds) :
    HasGlobalRankTwoThreeApolarAnnihilatorContradictions := by
  intro B p u hu hB hp hsocp
  exact rankTwoThreeAnnihilatorContradictions_of_dimensionBounds
    (hdims B p u hu hB hp hsocp)

theorem globalRankTwoThreeApolarAnnihilatorDimensionBounds_of_globalRankTwoThreeApolarAnnihilatorContradictions
    (hcontra : HasGlobalRankTwoThreeApolarAnnihilatorContradictions) :
    HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds := by
  intro B p u hu hB hp hsocp
  exact rankTwoThreeDimensionBounds_of_annihilatorContradictions
    (hcontra B p u hu hB hp hsocp)

theorem globalRankTwoThreeApolarAnnihilatorContradictions_iff_globalRankTwoThreeApolarAnnihilatorDimensionBounds :
...
theorem globalLowRankApolarHilbertData_of_globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData
  ...
  intro B p u hu hB hp hsocp
  exact lowRankApolarHilbertData_of_rankTwoMacaulayGrowth_rankThreeExactSequenceData
    (hgrowth2 B p u hu hB hp hsocp)
    (hdata3 B p u hu hB hp hsocp)

theorem globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData_of_globalLowRankApolarHilbertData
    (hdata : HasGlobalLowRankApolarHilbertData) :
    HasGlobalRankTwoApolarMacaulayGrowthBound ∧
      HasGlobalRankThreeApolarExactSequenceData := by
  exact ⟨
    fun B p u hu hB hp hsocp =>
      (rankTwoMacaulayGrowth_and_rankThreeExactSequenceData_of_lowRankApolarHilbertData
        (hdata B p u hu hB hp hsocp)).1,
    fun B p u hu hB hp hsocp =>
      (rankTwoMacaulayGrowth_and_rankThreeExactSequenceData_of_lowRankApolarHilbertData
        (hdata B p u hu hB hp hsocp)).2⟩

theorem globalLowRankApolarHilbertData_iff_globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData :
    HasGlobalLowRankApolarHilbertData ↔
      HasGlobalRankTwoApolarMacaulayGrowthBound ∧
        HasGlobalRankThreeApolarExactSequenceData :=
  ⟨globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData_of_globalLowRankApolarHilbertData,
    fun hdata =>
...
theorem globalRankThreeApolarAnnihilatorDimensionBound_of_globalRankThreeApolarBadBranchContradiction
    (hbad : HasGlobalRankThreeApolarBadBranchContradiction) :
    HasGlobalRankThreeApolarAnnihilatorDimensionBound := by
  intro B p u hu hB hp hsocp
  exact (rankThreeBadBranchContradiction_iff_rankThreeDimensionBound).mp
    (hbad B p u hu hB hp hsocp)

theorem globalRankThreeApolarBadBranchContradiction_of_globalRankThreeApolarAnnihilatorDimensionBound
    (hdim : HasGlobalRankThreeApolarAnnihilatorDimensionBound) :
    HasGlobalRankThreeApolarBadBranchContradiction := by
  intro B p u hu hB hp hsocp
  exact (rankThreeBadBranchContradiction_iff_rankThreeDimensionBound).mpr
    (hdim B p u hu hB hp hsocp)

theorem globalRankThreeApolarBadBranchContradiction_iff_globalRankThreeApolarAnnihilatorDimensionBound :
    HasGlobalRankThreeApolarBadBranchContradiction ↔
      HasGlobalRankThreeApolarAnnihilatorDimensionBound :=
  ⟨globalRankThreeApolarAnnihilatorDimensionBound_of_globalRankThreeApolarBadBranchContradiction,
    globalRankThreeApolarBadBranchContradiction_of_globalRankThreeApolarAnnihilatorDimensionBound⟩
...
theorem quaternaryQuartic_rankSeven_no_spurious_socp_of_globalRankTwoThreeDimensionBounds
    (hdim2 : HasGlobalRankTwoApolarAnnihilatorDimensionBound)
    (hdim3 : HasGlobalRankThreeApolarAnnihilatorDimensionBound) :
    QuaternaryQuarticRankSevenNoSpuriousSOCP :=
  quaternaryQuartic_rankSeven_no_spurious_socp_of_globalRankTwoDimension_and_rankThreeBadBranch
    hdim2
    (globalRankThreeApolarBadBranchContradiction_of_globalRankThreeApolarAnnihilatorDimensionBound
      hdim3)

theorem quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoThreeDimensionBounds :
    QuaternaryQuarticRankSevenNoSpuriousSOCP ↔
      HasGlobalRankTwoApolarAnnihilatorDimensionBound ∧
        HasGlobalRankThreeApolarAnnihilatorDimensionBound := by
  constructor
  · intro hmain
    have hdata :=
      (quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoDimension_and_rankThreeBadBranch).mp
        hmain
    exact ⟨hdata.1,
      globalRankThreeApolarAnnihilatorDimensionBound_of_globalRankThreeApolarBadBranchContradiction
        hdata.2⟩
  · intro hdata
    exact quaternaryQuartic_rankSeven_no_spurious_socp_of_globalRankTwoThreeDimensionBounds
      hdata.1 hdata.2

theorem globalRankTwoThreeApolarAnnihilatorDimensionBounds_of_splitGlobalRankTwoThreeDimensionBounds
    (hdim2 : HasGlobalRankTwoApolarAnnihilatorDimensionBound)
    (hdim3 : HasGlobalRankThreeApolarAnnihilatorDimensionBound) :
    HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds := by
  intro B p u hu hB hp hsocp
  exact ⟨hdim2 B p u hu hB hp hsocp,
    hdim3 B p u hu hB hp hsocp⟩

theorem splitGlobalRankTwoThreeDimensionBounds_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
    (hdims : HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds) :
    HasGlobalRankTwoApolarAnnihilatorDimensionBound ∧
      HasGlobalRankThreeApolarAnnihilatorDimensionBound := by
  exact ⟨
    fun B p u hu hB hp hsocp => (hdims B p u hu hB hp hsocp).1,
    fun B p u hu hB hp hsocp => (hdims B p u hu hB hp hsocp).2⟩

theorem globalRankTwoThreeApolarAnnihilatorDimensionBounds_iff_splitGlobalRankTwoThreeDimensionBounds :
    HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds ↔
      HasGlobalRankTwoApolarAnnihilatorDimensionBound ∧
        HasGlobalRankThreeApolarAnnihilatorDimensionBound :=
  ⟨splitGlobalRankTwoThreeDimensionBounds_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds,
    fun hdata =>
      globalRankTwoThreeApolarAnnihilatorDimensionBounds_of_splitGlobalRankTwoThreeDimensionBounds
        hdata.1 hdata.2⟩

theorem quaternaryQuartic_rankSeven_no_spurious_socp_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
    (hdims : HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds) :
    QuaternaryQuarticRankSevenNoSpuriousSOCP := by
  have hsplit :=
    splitGlobalRankTwoThreeDimensionBounds_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
...
theorem quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoThreeApolarAnnihilatorDimensionBounds :
    QuaternaryQuarticRankSevenNoSpuriousSOCP ↔
      HasGlobalRankTwoThreeApolarAnnihilatorDimensionBounds := by
  constructor
  · intro hmain
    exact globalRankTwoThreeApolarAnnihilatorDimensionBounds_of_splitGlobalRankTwoThreeDimensionBounds
      ((quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoThreeDimensionBounds).mp
        hmain).1
      ((quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoThreeDimensionBounds).mp
        hmain).2
  · intro hdims
    exact quaternaryQuartic_rankSeven_no_spurious_socp_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
      hdims

theorem quaternaryQuartic_rankSeven_no_spurious_socp_of_globalRankTwoThreeApolarAnnihilatorContradictions
    (hcontra : HasGlobalRankTwoThreeApolarAnnihilatorContradictions) :
    QuaternaryQuarticRankSevenNoSpuriousSOCP :=
  quaternaryQuartic_rankSeven_no_spurious_socp_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
    (globalRankTwoThreeApolarAnnihilatorDimensionBounds_of_globalRankTwoThreeApolarAnnihilatorContradictions
      hcontra)

theorem quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoThreeApolarAnnihilatorContradictions :
    QuaternaryQuarticRankSevenNoSpuriousSOCP ↔
      HasGlobalRankTwoThreeApolarAnnihilatorContradictions :=
  ⟨fun hmain =>
      globalRankTwoThreeApolarAnnihilatorContradictions_of_globalRankTwoThreeApolarAnnihilatorDimensionBounds
...
theorem quaternaryQuartic_rankSeven_no_spurious_socp_of_globalLowRankApolarHilbertData
    (hdata : HasGlobalLowRankApolarHilbertData) :
    QuaternaryQuarticRankSevenNoSpuriousSOCP := by
  have hbranches :=
    globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData_of_globalLowRankApolarHilbertData
...
theorem quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalLowRankApolarHilbertData :
    QuaternaryQuarticRankSevenNoSpuriousSOCP ↔
      HasGlobalLowRankApolarHilbertData :=
  ⟨fun hmain =>
      globalLowRankApolarHilbertData_of_globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData
        ((quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData).mp
          hmain).1
        ((quaternaryQuartic_rankSeven_no_spurious_socp_iff_globalRankTwoMacaulayGrowth_and_rankThreeExactSequenceData).mp
          hmain).2,
    quaternaryQuartic_rankSeven_no_spurious_socp_of_globalLowRankApolarHilbertData⟩
